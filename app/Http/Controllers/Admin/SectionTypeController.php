...
class SectionTypeController extends Controller
{
    ...
    public function selectList(Request $request)
    {
        ...
        $subjectSections = array_pluck(Section::where('subject_id',$request->id)->where('status',1)->get(['section_id'])->toArray(), 'section_id'); 
        $sectionTypes = SectionType::all(); 
        $data= view('admin.manage.section.selectList',compact('sectionTypes','subjectSections'))->render(); 
