...
class SectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.manage.section.manageSection',compact('sections','subjects','manageSections'));
    }
    ...
    {        
        ...
        $sectionOldDatas =  Section::where('subject_id',$request->subject)->get();  
        ...
        for ($i=0; $i < $section_count; $i++) { 
            ...
            $manageSection =Section::updateOrCreate(['subject_id'=>$request->subject,'section_id'=>$data['section_id'][$i]]);
            $manageSection->section_id = $data['section_id'][$i];
            $manageSection->subject_id = $data['subject'];
