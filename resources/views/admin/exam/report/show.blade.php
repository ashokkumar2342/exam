...
@section('body')
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="{{ route('admin.question.show.table') }}"  method="post"  class="add_form" target="_blank" accept-charset="utf-8" data-table="question_table" no-reset="true" success-content-id="question_div" id="question_form" toast-msg="true" search-url="{{ route('admin.question.show.print') }}" mathjax="true">
               {{ csrf_field() }} 
              <div class="row">
                <div class="col-lg-3">
