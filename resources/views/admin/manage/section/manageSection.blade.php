    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Subject Section</h3>
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <select class="form-control"  multiselect-form="true"  name="subject"  onchange="callAjax(this,'{{route('admin.section.selectList')}}'+'?id='+this.value,'section_list')" > 
                        <option value="" selected="" disabled>Subject Select</option>
              ...
              <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>{{ $manageSection->subjects->name or ''}}</td>                 
